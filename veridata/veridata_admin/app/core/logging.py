...
def setup_logging(log_level=logging.INFO):
    ...
    logging_config = {
        ...
        "formatters": {
            ...
            "pretty": {"()": PrettyJSONFormatter, "format": "%(asctime)s - %(name)s - %(levelname)s - %(message)s"},
        },
        "handlers": {
            "console": {
...
def log_job(logger, msg):
    logger.info(f"{EMOJI_JOB} Job: {msg}")
